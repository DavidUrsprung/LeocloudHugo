...
docker image tag ursprung-hugo-page ghcr.io/davidursprung/ursprung-hugo-page:latest
docker push ghcr.io/davidursprung/ursprung-hugo-page:latest
docker image tag hugo-backend-ursprung ghcr.io/davidursprung/hugo-backend-ursprung:latest
docker push ghcr.io/davidursprung/hugo-backend-ursprung:latest
